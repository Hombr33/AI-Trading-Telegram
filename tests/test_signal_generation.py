...
async def test_signal_generation():
    ...
    try:
        ...
        realtime_provider = RealtimeDataProvider(None)  # Will use OpenAI client directly
                ...
                if connection_success:
                    ...
                    if signal:
                        ...
                        real_data_indicators = [
                            ...
                            "market", "price", "eurusd", "forex", "trading"
                        ]
                        
                        real_data_found = sum(1 for indicator in real_data_indicators if indicator in signal_str)
    ...
    try:
        ...
        for model in test_models:
            ...
            try:
                ...
                print(f"     Web search supported: {'✅' if supports_web_search else '❌'}")
