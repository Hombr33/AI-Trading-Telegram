...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_webhooks_webhook_id'), 'webhooks', ['webhook_id'], unique=True)
    ...
    op.create_index(op.f('ix_journals_journal_id'), 'journals', ['journal_id'], unique=True)
