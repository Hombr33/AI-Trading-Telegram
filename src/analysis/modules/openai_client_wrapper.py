...
class OpenAIClientWrapper:
    ...
    def __init__(self, api_key: str, model: str = "gpt-4o-mini", max_retries: int = 3):
        ...
        self.model_capabilities = {
            "gpt-5": {"web_search": True, "realtime_data": True, "vision": True, "reasoning": True},
            "gpt-4o": {"web_search": True, "realtime_data": True, "vision": True},
            "gpt-4o-mini": {"web_search": True, "realtime_data": True, "vision": False},
            "gpt-4-turbo": {"web_search": False, "realtime_data": False, "vision": True},
            "gpt-3.5-turbo": {"web_search": False, "realtime_data": False, "vision": False}
        }
    ...
    async def create_chat_completion(self, 
                                   ...
                                   tool_choice: Optional[Union[str, Dict[str, str]]] = None) -> Optional[Any]:
...
Focus on specific price levels, recent movements, and relevant news. Return ONLY the JSON, no additional text."""
                    ...
                    try:
                        ...
                        if fixed_content != cleaned_content:
                            try:
                                ...
                                logger.info("Signal generated successfully after JSON fixing")
                                return signal_data
    ...
    def _looks_like_json(self, content: str) -> bool:
        ...
        if not any(keyword in content for keyword in ['"id"', '"symbol"', '"bias"', '"setups"']):
            return False
    ...
    async def create_chat_completion_with_web_search(self,
                                                   messages: List[Dict[str, Any]],
