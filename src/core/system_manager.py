...
class SystemManager:
    ...
    async def graceful_restart(self, telegram_bot=None, admin_telegram_id: Optional[int] = None) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            # 7. Schedule restart
            await self._schedule_restart(restart_script, telegram_bot, admin_telegram_id)
    ...
    async def _schedule_restart(self, restart_script: str, telegram_bot=None, admin_telegram_id: Optional[int] = None):
