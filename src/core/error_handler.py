...
async def _send_error_to_telegram(operation_name: str, error: Exception, context: Dict[str, Any]):
...
def safe_async_task(coro, operation_name: str, context: Optional[Dict[str, Any]] = None):
