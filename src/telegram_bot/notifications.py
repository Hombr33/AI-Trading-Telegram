...
class NotificationManager:
    ...
    async def send_signal_notification(self, signal_data: Dict):
        ...
        try:
            ...
            await self.send_notification(
                message, notification_type="signal", priority="high"
            )
    ...
    async def send_position_notification(self, position_data: Dict, action: str):
        ...
        try:
            ...
            await self.send_notification(
                message, notification_type="position", priority="medium"
            )
    ...
    async def send_risk_alert(self, alert_type: str, message: str, data: Dict = None):
        ...
        try:
            ...
            await self.send_notification(
                alert_message, notification_type="risk", priority="high"
            )
    ...
    async def send_performance_notification(self, performance_data: Dict):
        ...
        try:
            ...
            await self.send_notification(
                message, notification_type="performance", priority="medium"
            )
    ...
    async def send_startup_notification(self):
        ...
        try:
            ...
            await self.send_notification(
                message, notification_type="system", priority="low"
            )
    ...
    async def send_error_notification(
        self, error_message: str, component: str = "Unknown"
    ):
        ...
        try:
            ...
            await self.send_notification(
                message, notification_type="error", priority="high"
            )
    ...
    async def _send_notification_to_all(self, notification: Dict):
        ...
        for chat_id in self.chat_ids:
            try:
                ...
                logger.info(
                    f"Notification sent to {chat_id}: {notification_type} - {priority}"
                )
