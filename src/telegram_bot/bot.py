...
from telegram.ext import (
    Application, CommandHandler as TGCommandHandler, 
...
class TelegramBot:
    ...
    def _register_handlers(self):
        ...
        self.application.add_handler(TGCommandHandler("positions", self._positions_command))
        self.application.add_handler(TGCommandHandler("orders", self._orders_command))
        self.application.add_handler(TGCommandHandler("performance", self._performance_command))
        self.application.add_handler(TGCommandHandler("risk", self._risk_command))
        self.application.add_handler(TGCommandHandler("settings", self._settings_command))
    ...
    async def _status_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        try:
            ...
            await update.message.reply_text("❌ Failed to get system status. Please try again.")
    ...
    async def _positions_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        try:
            ...
            await update.message.reply_text("❌ Failed to get positions. Please try again.")
    ...
    async def _orders_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        try:
            ...
            await update.message.reply_text("❌ Failed to get orders. Please try again.")
    ...
    async def _performance_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        try:
            ...
            await update.message.reply_text("❌ Failed to get performance data. Please try again.")
    ...
    async def _risk_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        try:
            ...
            await update.message.reply_text("❌ Failed to get risk metrics. Please try again.")
    ...
    async def _settings_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        try:
            ...
            await update.message.reply_text("❌ Failed to get settings. Please try again.")
    
    async def _journal_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        try:
            ...
            await update.message.reply_text("❌ Failed to get trading journal. Please try again.")
    ...
    async def _message_handler(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        try:
            ...
            if "hello" in message or "hi" in message:
                await update.message.reply_text("👋 Hello! How can I help you today? Use /help to see available commands.")
            elif "how are you" in message:
                await update.message.reply_text("🤖 I'm running perfectly! Ready to help with your trading needs.")
            elif "thank" in message:
                await update.message.reply_text("🙏 You're welcome! Is there anything else you need?")
            else:
    ...
    async def send_notification(self, message: str, notification_type: str = "info"):
        ...
        try:
            ...
            await self.notification_manager.send_notification(message, notification_type)
            return True
