...
class Order(Base):
    ...
    order_type = Column(String(20), nullable=False)  # BUY, SELL, BUYLIMIT, SELLLIMIT, BUYSTOP, SELLSTOP
    ...
    status = Column(String(20), nullable=False, default="PENDING")  # PENDING, FILLED, PARTIAL, REJECTED, CANCELLED
