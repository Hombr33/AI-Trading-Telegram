...
class Alert(Base):
    ...
    alert_type = Column(String(50), nullable=False)  # TRADE_ALERT, RISK_ALERT, SYSTEM_ALERT, etc.
    ...
    delivery_method = Column(String(50), nullable=False)  # TELEGRAM, EMAIL, WEBHOOK, etc.
